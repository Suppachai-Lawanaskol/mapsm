...
{phang2}{cmd: mapsm cabg opcab onbhcab, group(sxtype) append}{p_end}
...
{phang2}{cmd: twoway (kdensity cabg if sx==0)(kdensity cabg if sx==1)(kdensity cabg if sx==2)(kdensity opcab if sx==0)(kdensity opcab if sx==1)(kdensity opcab if sx==2)(kdensity onbhcab if sx==0)(kdensity onbhcab if sx==1)(kdensity onbhcab if sx==2) if append}{p_end}

{phang2}{bf: twoway (kdensity cabg if sx==0)(kdensity cabg if sx==1)(kdensity cabg if sx==2)(kdensity opcab if sx==0)(kdensity opcab if sx==1)(kdensity opcab if sx==2)(kdensity onbhcab if sx==0)(kdensity onbhcab if sx==1)(kdensity onbhcab if sx==2) if !append}{p_end}
