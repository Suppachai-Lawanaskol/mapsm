...
{p 5 5 3}
After the 50 iterations, the maximum standardized difference is {cmd:0.0661}, and the seeding number is {cmd:1255}. Now, we are matching. Without {cmd:"notable"} option, pre-match and post-match cohort tabulations will be shown.
