...
{p2col:{opt ap:pend}} Append the postmatch dataset to the original dataset. Generate {cmd: append} 
variable to indicate the postmatch dataset for reporting balance diagnostic score and illustration.{p_end}
{p2colreset}{...}
...
{phang2}{stata mapsm cabg opcab onbhcab, group(sxtype) smd(sex age i.nyfc i.ccs aceiarb asa clopidogrel ckd5esrd i.cadtype lm) log: mapsm cabg opcab onbhcab, group(sxtype) smd(sex age i.nyfc i.ccs aceiarb asa clopidogrel ckd5esrd i.cadtype lm) log}{p_end}
