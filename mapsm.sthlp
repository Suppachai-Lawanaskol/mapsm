...
{p 5 5 3}
Create an imaginary matched cohort and record the seeding number. Report the smallest balance diagnostic value and its 
seeding number. Input the probability variable. Binary treatment group. Specify initiation seeding number to {cmd:1234}. 
Strata variable name, {cmd:"Block"}. Strata size of {cmd:10}. The iterate round of {cmd:200}. The Covariates 
accountable for the balance diagnostic are {cmd:Age, Body weight, Body mass index, Bilaterality, and Preoperative endometriotic diameter}. 
Strata tabulation across the treatment groups is suppressed.{p_end}
...
{phang2}{stata mapsm cabg opcab onbhcab, group(sxtype) seed(1255) name(block) size(10) replace: mapsm cabg opcab onbhcab, group(sxtype) seed(1255) name(block) size(10) replace}
