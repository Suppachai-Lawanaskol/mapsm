...
{phang2}{stata twoway (kdensity cabg if sx==0)(kdensity cabg if sx==1)(kdensity cabg if sx==2)(kdensity opcab if sx==0)(kdensity opcab if sx==1)(kdensity opcab if sx==2)(kdensity onbhcab if sx==0)(kdensity onbhcab if sx==1)(kdensity onbhcab if sx==2) if append==1: prematch distribution plot}{p_end}

{phang2}{stata twoway (kdensity cabg if sx==0)(kdensity cabg if sx==1)(kdensity cabg if sx==2)(kdensity opcab if sx==0)(kdensity opcab if sx==1)(kdensity opcab if sx==2)(kdensity onbhcab if sx==0)(kdensity onbhcab if sx==1)(kdensity onbhcab if sx==2) if append==0: postmatch distribution plot}{p_end}
