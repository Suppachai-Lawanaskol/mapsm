...
seeding number. Input the probability variable. Binary treatment groups. Specify initiation seeding number to {cmd:1234}. 
Strata variable name, {cmd:"Block"}. Strata size of {cmd:10}. The iteration round of {cmd:200}. The Covariates 
...
{p 5 5 3}
Create an imaginary matched cohort and record the seeding number. Report the smallest balance diagnostic value and its seeding number. Input the probability variable. Multiple treatment groups. Specify initiation seeding number to {cmd:1234}.
 Strata variable name, {cmd:"Block"}. Strata size of {cmd:10}. The iteration round of {cmd:50}. The Covariates accountable for the balance diagnostic are {cmd: Sex, Age, New York Heart Association (NYHA) functional class, Canadian Cardiovascular
